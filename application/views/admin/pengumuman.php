                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <center> <a
                                                            href="<?=base_url();?>assets/gambar/<?=$foto_pengumuman?>"
                                                        ...
                                                        <div class="modal-body">
                                                            <form
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="judul_pengumumam">Judul
                                                                        Pengumuman</label>
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="foto_pengumumam">Foto Pengumuman</label>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="<?=base_url();?>Data_pengumuman/tambah_pengumuman"
                                            enctype="multipart/form-data" method="POST">
                                            <div class="form-group">
                                                <label for="judul_pengumumam">Judul Pengumuman</label>
